...
```{r}
library(tidyverse)
class_list <- read_csv("~/Downloads/FALL__2019EEOB_546X_1.CSV") %>% select(`First Name`,`ISU EMAIL`)
View(class_list)
break()
#### Manually remove students who audit or don't come to class
class_list <- class_list[-c(18, 29), ]
#### Fix the name 
class_list[1,1] <- "Mahule"
#### End of manual fixes
...
Please send a link to your R assignment's GitHub repository to ",class_list[i,3]," and ", class_list[i,4]," for a peer review by 1:00 pm on 10/18!  Please  remember that it is your responsibility to submit your link and to return your reviews on time. 
